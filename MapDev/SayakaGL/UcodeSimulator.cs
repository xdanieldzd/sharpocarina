    ...
    public static class UcodeSimulator
    {
        ...
        private static void Ucode_F3DEX2_VTX(UInt32 w0, UInt32 w1)
        {
            ...
            for (int i = 0; i < N; i++)
            {
                ...
                {
                    Position = new Vector3d((double)GameHandler.Read16S(GameHandler.RAM[VSegment].Data, VOffset), (double)GameHandler.Read16S(GameHandler.RAM[VSegment].Data, VOffset + 2), (double)GameHandler.Read16S(GameHandler.RAM[VSegment].Data, VOffset + 4)),
        ...
        private static void CalculateTextureSize(int ActiveTexture)
        {
        ...
        private static int CheckTextureCache(int ActiveTexture)
        {
